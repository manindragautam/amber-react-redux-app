...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber React Redux App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 8dWA_nud7yKojV7SUwE6e9NDAfWI7jbmU5TvB2tQTKg
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-react-redux-app.log", "w"))
  #
  #
end
